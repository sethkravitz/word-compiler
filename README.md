...
Word Compiler is designed as a **self-hosted, single-user, localhost application**. The API server binds to `127.0.0.1` by default and CORS is restricted to the Vite dev origin (`localhost:5173`).
